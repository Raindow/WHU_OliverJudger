<template>
  <div class="contestsInformation_detail">
    <span class="titleStyle" v-html=" getDetail (title)"></span>

    <span class="detailContentStyle" v-html=" getDetail (detailContent)"></span>
    <span class="contestRules">
    <VariableTable
